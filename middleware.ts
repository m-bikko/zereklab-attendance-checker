...
export function middleware(request: NextRequest) {
    ...
    if (pathname === '/login') {
        ...
        if (authRole === 'analyst') return NextResponse.redirect(new URL('/analyst', request.url));
...
export const config = {
    matcher: ['/admin/:path*', '/parent/:path*', '/teacher/:path*', '/volunteer/:path*', '/analyst/:path*', '/', '/login'],
};
